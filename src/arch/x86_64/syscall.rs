...
#[no_mangle]
static mut NORX_X86_64_USER_DISPATCH_TRAPS: u64 = 0;
#[no_mangle]
static mut NORX_X86_64_INT80_HITS: u64 = 0;
#[no_mangle]
static mut NORX_X86_64_INT80_FAST_HITS: u64 = 0;
#[no_mangle]
static mut NORX_X86_64_INT80_LAST_OP: u64 = 0;

#[no_mangle]
static mut NORX_X86_64_SYSCALL_STACK_TOP: u64 = 0;
#[no_mangle]
static mut NORX_X86_64_USER_PROBE_ACTIVE: u8 = 0;
#[no_mangle]
static mut NORX_X86_64_USER_PROBE_DONE: u8 = 0;
#[no_mangle]
static mut NORX_X86_64_USER_PROBE_RETURN_RSP: u64 = 0;
#[no_mangle]
static mut NORX_X86_64_USER_PROBE_RETURN_RIP: u64 = 0;
#[no_mangle]
static mut NORX_X86_64_USER_PROBE_VALUE: u64 = 0;
#[no_mangle]
static mut NORX_X86_64_USER_PROBE_FAULT_RIP: u64 = 0;
...
norx_x86_64_syscall_entry:
    mov r12, rsp
    mov rsp, qword ptr [rip + NORX_X86_64_SYSCALL_STACK_TOP]
    and rsp, -16
    push r12
    push rcx
    push r11
...
pub fn init() {
    unsafe {
        NORX_X86_64_SYSCALL_STACK_TOP = crate::arch::tables::tss_status().rsp0;
...
pub fn status() -> Status {
    Status {
        ...
        traps: TRAPS.load(Ordering::Relaxed)
            + unsafe { core::ptr::addr_of!(NORX_X86_64_USER_DISPATCH_TRAPS).read_volatile() },
        int80_hits: unsafe { core::ptr::addr_of!(NORX_X86_64_INT80_HITS).read_volatile() },
        int80_fast_hits: unsafe {
            core::ptr::addr_of!(NORX_X86_64_INT80_FAST_HITS).read_volatile()
        },
        int80_last_op: unsafe { core::ptr::addr_of!(NORX_X86_64_INT80_LAST_OP).read_volatile() },
        lstar: unsafe { rdmsr(IA32_LSTAR) },
        star: unsafe { rdmsr(IA32_STAR) },
        fmask: unsafe { rdmsr(IA32_FMASK) },
        kernel_stack_top: unsafe { NORX_X86_64_SYSCALL_STACK_TOP },
        kernel_stack_slot: (&raw const NORX_X86_64_SYSCALL_STACK_TOP) as u64,
        user_probe_active: unsafe { NORX_X86_64_USER_PROBE_ACTIVE },
        user_probe_done: unsafe { NORX_X86_64_USER_PROBE_DONE },
        user_probe_fault_rip: unsafe {
            core::ptr::addr_of!(NORX_X86_64_USER_PROBE_FAULT_RIP).read_volatile()
        },
    }
}
...
pub fn user_probe_active() -> bool {
    unsafe { NORX_X86_64_USER_PROBE_ACTIVE != 0 }
}
...
pub fn begin_user_probe() -> bool {
    ...
    unsafe {
        NORX_X86_64_USER_PROBE_VALUE = 0;
        NORX_X86_64_USER_PROBE_FAULT_RIP = 0;
        NORX_X86_64_USER_PROBE_DONE = 0;
        NORX_X86_64_USER_PROBE_ACTIVE = 1;
    }
    true
}
...
pub fn enter_user_probe(rip: u64, rsp: u64) -> u64 {
    ...
    unsafe {
        asm!(
            "lea rax, [rip + 2f]",
            "mov qword ptr [rip + NORX_X86_64_USER_PROBE_RETURN_RIP], rax",
            "mov qword ptr [rip + NORX_X86_64_USER_PROBE_RETURN_RSP], rsp",
            "mov ax, 0x1b",
            "mov ds, ax",
            "mov es, ax",
            "mov rax, 0x1b",
...
fn handle(op: u64, args: [u64; 6]) -> crate::abi::syscall::Return {
    ...
    if matches!(op, crate::abi::syscall::UniversalOp::Exit) && ret.error == 0 {
        unsafe {
            if NORX_X86_64_USER_PROBE_ACTIVE != 0 {
                NORX_X86_64_USER_PROBE_VALUE = ret.value;
                NORX_X86_64_USER_PROBE_DONE = 1;
            }
        }
    }
    ret
